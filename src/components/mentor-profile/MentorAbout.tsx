...
const MentorAbout = ({ mentor }: MentorAboutProps) => {
    ...
    .map((cert) => {
      ...
      if (cert && typeof cert === "object") {
        ...
        return (
          ...
          (typeof item.certificateName === "string" &&
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
          ...
          >
            ...
            >
              {mentor.about || "No information available."}
            </p>

            {mentor.about && mentor.about.length > 250 && (
              <button
          ...
          <div className="mt-12">
            ...
            <p className="text-slate-500 mb-6">
              A snapshot of organizations where this mentor has contributed
                ...
                {certifications.length > 3 && (
                  <div className="flex justify-center mt-8">
                    <button
                      onClick={() =>
                        navigate(
                          `/mentor/${mentor.id}/certifications`
                        )
                      }
                      className="
                        px-6
          ...
          <div className="mt-12">
            ...
            <p className="text-slate-500 mt-2 mb-6">
              Milestones and accomplishments throughout the mentor&apos;s
              journey.
            </p>
