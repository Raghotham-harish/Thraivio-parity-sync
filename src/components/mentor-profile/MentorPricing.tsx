...
rounded-lg">
        Selected
            ...
            <p className="text-slate-500 mt-2">
             {mentor.sessionDuration.introCall}
            </p>
...
rounded-lg">
        Selected
              ...
              <p className="text-slate-500 mt-2">
                 {mentor.sessionDuration.mentorshipCall}
              </p>
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
...
rounded-lg">
        Selected
              ...
              <p className="text-slate-500 mt-2">
                {mentor.sessionDuration.mockInterview}
              </p>
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
...
>
  Most Popular
              ...
              <p className="text-slate-500 mt-2">
               {mentor.sessionDuration.monthlyProgram}
              </p>
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
