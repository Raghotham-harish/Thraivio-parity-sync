...
> = {
  ...
  published: {
    label: "Published",
    className:
      "border-green-200 bg-green-50 text-[#065F46]",
  },
  closed: {
    label: "Closed",
    className:
...
export default function AdminSurveyCard({
  ...
  return (
    <article className="flex h-full flex-col rounded-xl border border-border bg-card p-5 shadow-sm transition hover:border-border hover:shadow-md">
      {/* Header */}
      ...
      <div className="mt-5 rounded-lg bg-secondary p-3">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-card text-muted-foreground shadow-sm">
            <UserRound size={17} />
          </div>
      ...
      <div className="mt-auto flex items-center gap-2 pt-5">
        <button
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-border bg-card px-3 py-2.5 text-sm font-medium text-foreground transition hover:bg-secondary"
        >
          <Eye size={16} />
          Preview
        </button>
        ...
        <div className="relative">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-lg border border-border bg-card text-muted-foreground transition hover:bg-secondary hover:text-foreground"
          >
