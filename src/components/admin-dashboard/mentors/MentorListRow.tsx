...
export default function MentorListRow({
  ...
  return (
    <div className="grid grid-cols-[2.5fr_0.8fr_0.9fr_0.9fr_0.9fr_1fr_1.3fr] items-center gap-6 border-b border-border px-6 py-5 transition hover:bg-secondary">
      {/* Mentor */}
